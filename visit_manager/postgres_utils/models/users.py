...
from sqlalchemy import CheckConstraint, Enum, ForeignKey, UniqueConstraint, select
...
class ChatSession(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "vendor_id"),
        # UniqueConstraint('visit_id', 'user_id', 'vendor_id'),
    )
    ...
    #     ForeignKey("visit.visit_id"), nullable=True, index=True
    # )
